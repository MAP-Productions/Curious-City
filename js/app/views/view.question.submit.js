...
(function(Questions) {
	...
	Questions.Views.Submit = Backbone.View.extend({
		...
		render : function()
		{
			$('#flash .super h1').html('What do you wonder about Chicago,the region, or the people who live here?');
			$('#flash .sub h5').html('Please write your question');
			return this;
		},
		events : {
		...
		back: function()
		{
			...
			if(this.step==3){
				...
				$('#question-form-3').fadeOut('fast',function(){
					...
					$('#flash .super h1').html('If your question is chosen and we need to follow up, let us know how to contact you?');
					$('#flash .sub h5').empty();
				});
				this.step--;
			}
		...
		next: function()
		{
			...
			else if (this.step==2)
			{
				...
				$('#question-form-2').fadeOut('fast',function(){
					...
					$('#flash .super h1').html('Double check your question');
					$('#flash .sub h5').empty();
				});
				this.step++;
			}
				...
				"<div class='span7'>"+
					"<div class='question-form-wrapper'>"+
						"<div id='question-form-1' class='question-form'>"+
							//"<label><h1>What do you wonder about Chicago,the region, or the people who live here?</h1></label>"+
						...
						"<form id='question-form-2'  class='question-form hide'>"+
							//"<h1>If your question is chosen and we need to follow up, let us know how to contact you.</h1>"+
						...
						"<form id='question-form-3' class='question-form hide'>"+
							//"<h1>Double check your question</h1>"+
