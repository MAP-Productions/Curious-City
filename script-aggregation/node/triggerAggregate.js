var Path = require('path'),
    ...
    aggregate = function(config){
        ...
        for(var ci in config.convert){
            ...
            console.log("Starting", (config.uglify) ? "compressed (slow)":"loose (fast)" ,"aggregation ", parseInt(ci,10)+1, "of", config.convert.length);
            ...
            requirejs.optimize(convertProfile, function (buildResponse) {
                ...
                console.log("   Finished aggregation in ", parseInt(duration/1000,10), "seconds");
